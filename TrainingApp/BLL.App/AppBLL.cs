...
namespace BLL.App
{
    public class AppBLL : BaseBLL<IAppUnitOfWork>, IAppBLL
    {
        ...
        public AppBLL(IAppUnitOfWork unitOfWork, UserManager<AppUser> userManager, 
            SignInManager<AppUser> signInManager, RoleManager<AppRole> roleManager, IConfiguration configuration, IPlayerPositionService playerPositionService, IEmailSender emailSender) : base(unitOfWork)
        {
        ...
        public IFeedbackService FeedbackService => 
            GetService<IFeedbackService>(() => new FeedbackService(UnitOfWork));
        ...
        public ITrainingService TrainingService =>
            GetService<ITrainingService>(() => new TrainingService(NotificationService, CommentService, UnitOfWork));
