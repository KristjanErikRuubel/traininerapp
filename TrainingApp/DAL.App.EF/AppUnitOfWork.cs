...
namespace DAL.App.EF
{
    public class AppUnitOfWork : EFBaseUnitOfWork<AppDbContext>, IAppUnitOfWork
    {
        ...
        public ITrainingTeamRepository TrainingTeamRepository =>
            GetRepository<ITrainingTeamRepository>(() => new TrainingTeamRepository(UOWDbContext));
        public IUserInTrainingTeamRepository UserInTrainingTeamRepository=>
            GetRepository<IUserInTrainingTeamRepository>(() => new UserInTrainingTeamRepository(UOWDbContext));
